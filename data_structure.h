...
const byte BLOCKDEVICE=2; //块设备文件 (单纯地定义,在本系统中未使用)
const byte PIP=3; //管道文件 (单纯地定义,在本系统中未使用)
...
short stackLock; //空闲盘块号栈是临界资源,这个变量作为空闲盘块号栈的锁,值域为{0,1},值为1表示已上锁 (实际上在本系统中未使用)
